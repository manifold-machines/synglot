python main.py translate --hf-dataset MMMU/MMMU --hf-config Psychology --hf-split validation --target-lang mk --columns 'question','options' --source-lang en --backend nllb --streaming-mode --batch-size 100
